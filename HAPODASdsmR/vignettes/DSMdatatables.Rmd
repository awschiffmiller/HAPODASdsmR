...
### Observation Data:  
  ...
  The initail data used to make the 'Obsdata' is the 'short_hapodas' data, which is the shortened version of the raw HAPODAS data.
